...
from include.ingest_homework import process_data, upload_to_minio
from include.preprocessing_homework import run_preprocessing
from include.training_homework import run_train
...
EXPERIMENT_NAME = "lr_experiment-HW"
REGISTERED_MODEL_NAME = "LR-Model-HW"
...
@dag(
    dag_id="full_training_pipeline-Homework",
    schedule_interval="@once",
    start_date=datetime(2024, 1, 1),
    catchup=False,
    default_args=default_args,
    dagrun_timeout=timedelta(hours=2),
    tags=["yellow-taxi", "mlops-HW", "training", "minio"],
)
def full_training_pipeline():
    ...
    @task(execution_timeout=timedelta(minutes=60), retries=1, retry_delay=timedelta(minutes=2))
